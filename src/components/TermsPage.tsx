              ...
              <div className="flex-1 max-w-3xl">
                <div className="space-y-12">
                  <section id="acceptance">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">1.</span>Acceptance of Terms</h2>
                    <p className="text-[#475569] leading-relaxed">By accessing or using i18nCheck.dev and i18ncheck.dev (the "Service"), operated by Alpha Web Creation LLC ("we", "our", "us"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.</p>
                  </section>

                  <section id="description">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">2.</span>Description of Service</h2>
                    <p className="text-[#475569] leading-relaxed">i18nCheck is a web-based internationalization (i18n) layout testing tool. The Service allows users to submit website URLs for automated layout stress-testing using pseudo-localization techniques, including text expansion, RTL layout simulation, and CJK character rendering.</p>
                  </section>

                  <section id="user-accounts">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">3.</span>User Accounts</h2>
                  ...
                  <section id="acceptable-use">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">4.</span>Acceptable Use</h2>
                    <p className="text-[#475569] leading-relaxed mb-4">You agree <strong className="text-[#0f172a]">NOT</strong> to:</p>
                    <ul className="list-disc list-inside space-y-2 text-[#475569]">
                  ...
                  <section id="plans">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">5.</span>Free and Paid Plans</h2>
                    <ul className="list-disc list-inside space-y-2 text-[#475569]">
                  ...
                  <section id="payment">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">6.</span>Payment and Billing</h2>
                    <ul className="list-disc list-inside space-y-2 text-[#475569]">
                  ...
                  <section id="ip">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">7.</span>Intellectual Property</h2>
                    <ul className="list-disc list-inside space-y-2 text-[#475569]">
                  ...
                  <section id="third-party">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">8.</span>Third-Party Websites</h2>
                    <p className="text-[#475569] leading-relaxed">The Service accesses third-party websites that you submit for testing. We are not responsible for the content, accuracy, or availability of those websites. Scanning a website does not imply endorsement.</p>
                  </section>

                  <section id="api-usage">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">9.</span>API Usage</h2>
                    <ul className="list-disc list-inside space-y-2 text-[#475569]">
                  ...
                  <section id="disclaimer">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">10.</span>Disclaimer of Warranties</h2>
                    <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-xl p-6">
                      <p className="text-[#475569] leading-relaxed mb-4 uppercase text-sm font-medium">THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. WE DO NOT GUARANTEE THAT:</p>
                      <ul className="list-disc list-inside space-y-2 text-[#475569]">
                  ...
                  <section id="liability">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">11.</span>Limitation of Liability</h2>
                    <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-xl p-6">
                      <p className="text-[#475569] leading-relaxed uppercase text-sm font-medium">TO THE MAXIMUM EXTENT PERMITTED BY LAW, ALPHA WEB CREATION LLC SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE SERVICE. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID US IN THE 12 MONTHS PRECEDING THE CLAIM.</p>
                    </div>
                  </section>

                  <section id="indemnification">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">12.</span>Indemnification</h2>
                    <p className="text-[#475569] leading-relaxed">You agree to indemnify and hold harmless Alpha Web Creation LLC from any claims, damages, or expenses arising from your use of the Service or violation of these Terms.</p>
                  </section>

                  <section id="termination">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">13.</span>Termination</h2>
                    <ul className="list-disc list-inside space-y-2 text-[#475569]">
                  ...
                  <section id="governing-law">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">14.</span>Governing Law</h2>
                    <p className="text-[#475569] leading-relaxed">These Terms are governed by the laws of the State of Wyoming, United States, without regard to conflict of law principles.</p>
                  </section>

                  <section id="changes">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">15.</span>Changes to Terms</h2>
                    <p className="text-[#475569] leading-relaxed">We may update these Terms from time to time. Continued use of the Service after changes constitutes acceptance. We will notify users of significant changes via email or a notice on the Service.</p>
                  </section>

                  <section id="contact-us">
                    <h2 className="text-xl font-bold mb-4 text-[#0f172a]"><span className="text-[#94a3b8] mr-2">16.</span>Contact</h2>
                    <p className="text-[#475569] leading-relaxed mb-4">For questions about these Terms, contact us at:</p>
